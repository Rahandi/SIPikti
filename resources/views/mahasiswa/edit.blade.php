...
<body onkeypress="return noEnter()">
	<div class="row" style="align-content: center; margin-top: 3%; margin-bottom: 5%;">
		<div class="col-sm-10 col-md-offset-10 mx-auto" style="z-index: 1;">
			...
			<form id="msform" method="POST" action="{{route('mahasiswa.update')}}" enctype="multipart/form-data" data-mjf="form_required" name="daftarin" id="daftarin">
				{{ csrf_field() }}
				<ul id="progressbar">
				...
				<fieldset>
					...
					<a href="{{route('mahasiswa')}}"><input type="button" name="cancel" class="action-button" value="Cancel" style="text-align: center;"/></a>
