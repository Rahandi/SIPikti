									...
									<div class="form-row">
										<div class="form-holder">
											<label class="form-row-inner">
												...
												<span class="label">Nama Institusi sd</span>
											</label>
										</div>
										<div class="form-holder">
											<label class="form-row-inner">
								...
								<div id="sltp_pendidikan">
									<div class="form-row">
										<div class="form-holder">
											<label class="form-row-inner">
												<input type="text" class="form-control" name="sd_institusi" required>
												<span class="label">Nama Institusi sltp</span>
											</label>
										</div>
										<div class="form-holder">
											<label class="form-row-inner">
								...
								<div id="slta_pendidikan">
									<div class="form-row">
										<div class="form-holder">
											<label class="form-row-inner">
												<input type="text" class="form-control" name="sd_institusi" required>
												<span class="label">Nama Institusi slta</span>
											</label>
										</div>
										<div class="form-holder">
											<label class="form-row-inner">
								...
								<div id="diploma_pendidikan">
									<div class="form-row">
										<div class="form-holder">
											<label class="form-row-inner">
												<input type="text" class="form-control" name="sd_institusi" required>
												<span class="label">Nama Institusi diploma</span>
											</label>
										</div>
										<div class="form-holder">
											<label class="form-row-inner">
								...
								<div id="sarjana_pendidikan">
									<div class="form-row">
										<div class="form-holder">
											<label class="form-row-inner">
												<input type="text" class="form-control" name="sd_institusi" required>
												<span class="label">Nama Institusi sarjana</span>
											</label>
										</div>
										<div class="form-holder">
											<label class="form-row-inner">
								...
								<div id="lain_pendidikan">
									<div class="form-row">
										<div class="form-holder">
											<label class="form-row-inner">
												<input type="text" class="form-control" name="sd_institusi" required>
												<span class="label">Nama Institusi lainnya</span>
											</label>
										</div>
										<div class="form-holder">
											<label class="form-row-inner">
