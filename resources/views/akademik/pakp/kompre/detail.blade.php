			...
			<div class="white-box">
                ...
                <div class="row" id="tombol">
                    ...
                    <div class="col-md-6" style="text-align: right">
                        <a href="{{route('pakp.download_template', ['jenis' => 'kompre', 'tahun' => $data->tahun])}}"><button class="btn btn-danger">Download Template Penilaian</button></a>
				...
				<table style="width:100%;" border="">
                    <thead>
                        <tr name="kompre">
                            ...
                            <th style="width: 24%">Nilai Komprehensif</th>
                ...
                <div id="modalDelete" class="w3-modal w3-round-xlarge" style="z-index: 99999;">
                    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round-large" style="width: 40%;">
                        ...
                        <div class="w3-container" style="margin-top: 2%;">
                            <p>Apakah Anda yakin akan menghapus mahasiswa ini dari Komprehensif?</p>
                        </div>
                        <footer class="w3-container w3-light-grey w3-round-large" style="text-align: right;">
                            <form action="{{route('pakp.delete', ['jenis' => 'kompre', 'tahun' => $data->tahun])}}" method="POST">
                                {{ csrf_field() }}
                ...
                <div id="modalUpload" class="w3-modal w3-round-xlarge" style="z-index: 99999;">
                    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round-large" style="width: 40%;">
                        ...
                        <form action="{{route('pakp.upload_template', ['jenis' => 'kompre', 'tahun' => $data->tahun])}}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="w3-container" style="margin-top: 2%;">
