...
<div class="row">
	<div class="col-sm-12">
		<div class="white-box">
			...
			<p class="text-muted m-b-30">Tambahkan Gelombang</p>
			<form action="{{route('master.gelombang.store')}}" method="POST" data-toggle="validator">
				{{csrf_field()}}
				<div class="col-md-12">
					<div class="form-group" style="width: 25%;">
						<label for="inp1" class="control-label">Nama Gelombang</label>
						<input type="text" class="form-control" id="inp1" name="nama" placeholder="1" required>
					</div>
				</div>
				<div>
					<div class="col-md-5">
						<div class="form-group">
							...
							<input type="date" class="form-control" id="inp2" name="mulai" required>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<input type="date" class="form-control" id="inp3" name="berakhir" required>
						</div>
					</div>
				</div>
