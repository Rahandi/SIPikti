			...
			<form id="msform" method="POST" action="{{route('daftar.store')}}" enctype="multipart/form-data">
				...
				<div id="form_1">
					...
					<fieldset style="text-align: center;">
						...
						<table style="width: 100%;">
							<tr>
								<td style="width: 30%;"><span><input id="radGelombang1" type="radio" name="gelombang" value="1">Gelombang 1</span></td>
								<td style="width: 30%;"><span><input id="radGelombang2" type="radio" name="gelombang" value="2">Gelombang 2</span></td>
								<td style="width: 30%;"><span><input id="radGelombang3" type="radio" name="gelombang" value="3" checked>Gelombang 3</span></td>
							</tr>
						</table>
