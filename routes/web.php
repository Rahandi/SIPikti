...
Route::group(['prefix' => 'akademik'], function () {
    ...
    Route::group(['prefix' => 'nilai'], function () {
        ...
        Route::get('/detail/{id}', 'PenilaianController@detail')->name('nilai.detail');
    ...
    Route::group(['prefix' => 'pakp'], function () {
        ...
        Route::post('/upload_template/{jenis}/{tahun}', 'AkhirController@upload_template')->name('pakp.upload_template');
